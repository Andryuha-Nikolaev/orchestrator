...
- For web/UI tasks, use Playwright MCP to validate UX through key interactions, UI states, and navigation flows.
- For tasks outside web/UI scope, do not use Playwright MCP.
- For non-web/UI tasks, explicitly state in your result that Playwright MCP is not applicable.
