...
3. **Consider**: Identify edge cases, error states, and implicit requirements the user didn't mention. Use sequentialthinking MCP to structure complex reasoning, explore multi‑option scenarios, and validate logical dependencies.
